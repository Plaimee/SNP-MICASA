...
export default function RegisterPage() {
  ...
  function submitFormToNextPage(values:IFormCreateAccount) {
    setLoading(true)
    console.log(values)
    navigate('/register/more-detail', {state: {account: values}})
    setLoading(false)
  }
  ...
  return (
   <div className="wrap-items-center">
    ...
    <Formik
      ...
      onSubmit={(values: IFormCreateAccount) => submitFormToNextPage(values)}
    >
            ...
            <div className="w-full md:w-6/12 pad-main">
             ...
             <div className="container-button mt-3">
              <button disabled={loading}  type="submit" className="btn-bfl btn-main" >
                {loading ? <i className="fa-solid fa-spinner animate-spin"></i> : "ถัดไป"}
              </button>
            </div>
