...
import { IStateLocation } from "@/@types/authentication/IStateLocation";
...
export default function MoreRegisterDetailPage() {
  ...
  const { account }:IStateLocation = location.state || {};
        ...
        <Form>
          <div className="wrap-items-center">
            ...
            <div className="container-button pad-main mt-3">
              ...
              <button type="reset" className="btn-bfl btn-sub" onClick={() => navigate('/register')}>
                ย้อนกลับ
              </button>
            </div>
          </div>
